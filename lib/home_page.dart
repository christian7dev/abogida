...
//import 'package:abogida/drawer/bot/bot_main_page.dart';
              ...
              children: [
                UserAccountsDrawerHeader(
                  ...
                  currentAccountPicture: CircleAvatar(
                    backgroundImage: NetworkImage(info.photoURL.toString()),
                  ),
                ),
                ListTile(
                  title: Text("Game"),
                  ...
                  onTap: () {
                    Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => QuizStarter()));
                  },
                ),
                ListTile(
                  title: Text("Bot"),
                  ...
                  onTap: () {
                    //Navigator.of(context).push(MaterialPageRoute(builder: (context) => BotMainPage()));
                  },
                ),
                ListTile(
                  title: Text("Logout"),
